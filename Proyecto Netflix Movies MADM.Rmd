...
ggplot(movies_onfire, aes(text = paste('Votes:', Votes), ID = MovieID, y = Ranking, x = Year )) +  #text para visualizar votos en el interactivo
  ...
  labs(fill = 'Votes')                            #Legend name
```
También puedes visualizar la [versión interactiva](https://rawcdn.githack.com/paul-rami/proyecto-netflix-movies-madm/main/Heatmap%20Interactivo/Heatmap_Interactivo.html?token=ANOBI62VVCSVXQCX5IWW4HS74DG2A) de este gráfico.
